...
public sealed class ServerResponse(string? dataType, string traceId, IEnumerable? data) : IServerResponse
{
    ...
    public static IServerResponse CreateServerResponse(ErrorList errorList, string traceIdentifier)
    ...
    public static IServerResponse CreateServerResponseFromString(IEnumerable<string> str, string traceIdentifier)
        => new ServerResponse(
            typeof(string).Name,
            traceIdentifier,
            str
    ...
    public static IServerResponse CreateServerResponseFromObject(object obj, string traceIdentifier)
